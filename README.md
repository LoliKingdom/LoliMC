<p align="center">
  <img src="./lolimc.png" alt="LoliMC logo"/>
</p>
<br>

LoliMC is a custom launcher for Minecraft that focuses on predictability, long term stability and simplicity.

This is a **fork** of the PolyMC Launcher, which is a fork of the MultiMC Launcher and not endorsed by MultiMC.
If you want to read about why the original fork was created, check out [their FAQ page](https://polymc.org/wiki/overview/faq/).
<br>

# Installation

- All instructions for LoliMC can be found [here](https://polymc.org/download/)
- Downloads will probably be in the Releases page [here](https://github.com/LoliKingdom/LoliMC/releases)
- Last build status: https://github.com/LoliKingdom/LoliMC/actions
...
<!-- Someone should add whichever discord server here, would Cleanroom work for this? -->
...
If you want to contribute to LoliMC you might find it useful to join our Discord Server or Matrix Space.

## Building

If you want to build LoliMC yourself, check [Build Instructions](https://polymc.org/wiki/development/build-instructions/) for build instructions.
